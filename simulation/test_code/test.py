...
if opt.use_dynamic_mask == True:
    ...
    model_mask.load_state_dict(torch.load('/home/czy/NET/spectral/DMDC/simulation/train_code/exp/DMDC_9stg2023_04_09_21_29_56/model/model_mask_epoch_191.pth'))

model = model_generator(opt.method, opt.pretrained_model_path).cuda()

model.load_state_dict(torch.load('/home/czy/NET/spectral/DMDC/simulation/train_code/exp/DMDC_9stg2023_04_09_21_29_56/model/model_epoch_191.pth'))
...
def test():
    ...
    # mask3d, Phi, Phi_s = Variable(mask3d).cuda().float(), Variable(Phi).cuda().float(), Variable(Phi_s).cuda().float()
