...
if opt.use_dynamic_mask == True:
    ...
    model_mask.load_state_dict(torch.load(
        '/home/czy/NET/spectral/DMDC/simulation/train_code/exp/DMDC_7stg2023_04_17_09_14_27/model/model_mask_epoch_10.pth'))

model = model_generator(opt.method, opt.pretrained_model_path).cuda()

model.load_state_dict(torch.load('/home/czy/NET/spectral/DMDC/simulation/train_code/exp/DMDC_7stg2023_04_17_09_14_27/model/model_epoch_10.pth'))
