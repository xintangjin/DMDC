...
parser.add_argument('--outf', type=str, default='./exp/DMDC_5stg', help='saving_path')

# Model specifications
parser.add_argument('--use_dynamic_mask', type=bool, default=True, help='use dynamic mask')
parser.add_argument('--pretrained_mask_path', type=str, default=None, help='pretrained model directory')
parser.add_argument('--method', type=str, default='DMDC_5stg', help='method name')
...
parser.add_argument("--loss", type=bool, default=True, help='use loss2')
