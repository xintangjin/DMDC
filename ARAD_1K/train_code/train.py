...
if opt.use_dynamic_mask == True:
    ...
    model_mask.load_state_dict(torch.load('/home/czy/NET/spectral/DMDC_ARAD_1K/simulation/train_code/exp/DMDC_5stg2023_04_17_15_56_22/model/model_mask_epoch_191.pth'))

model = model_generator(opt.method, opt.pretrained_model_path).cuda()
model.load_state_dict(torch.load('/home/czy/NET/spectral/DMDC_ARAD_1K1/simulation/train_code/exp/DMDC_5stg2023_06_08_06_36_13/model/model_epoch_30.pth'))
