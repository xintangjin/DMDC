...
if opt.use_dynamic_mask == True:
    ...
    model_mask.load_state_dict(torch.load('/home/czy/NET/spectral/DMDC_ARAD_1K1/simulation/train_code/exp/DMDC_9stg2023_04_23_09_00_56/model/model_mask_epoch_213.pth'))

model = model_generator(opt.method, opt.pretrained_model_path).cuda()
model.load_state_dict(torch.load('/home/czy/NET/spectral/DMDC_ARAD_1K1/simulation/train_code/exp/DMDC_9stg2023_04_23_09_00_56/model/model_epoch_213.pth'))
